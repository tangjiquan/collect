...
public class PathMatchingResourcePatternResolver implements ResourcePatternResolver {
	...
	//���������ʹ�õ��õ�getResources()����
	//��AbstractBeanDefinitionReader�����ķ���public int loadBeanDefinitions(String location, Set actualResources)
	//throws BeanDefinitionStoreException {}
	//������õģ�Resource[] resources = ((ResourcePatternResolver) resourceLoader).getResources(location);
	//�����resouceLoader����FileSystemXmlApplicationContext������Ϊ��ʵ����resourceLoader����ӿڣ���������ӵ�ʵ����ResourcePatternResolver��
	//����PathMatchingResourcePatternResolverҲʵ����ResourcePatternResolver�����resourceLoader�ϵ�����
