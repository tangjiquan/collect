...
public abstract class AbstractRefreshableApplicationContext extends AbstractApplicationContext {
	...
	protected final void refreshBeanFactory() throws BeansException {
		if (hasBeanFactory()) {//ͬ����ʽ�ж��Ƿ��������߳��Ѿ���ʼ����BeanFactory������У������١�  
			destroyBeans();//����bean
			closeBeanFactory();//�ر�bean
		}
		try {
			//���createBeanFactory()�����õ���beanFactory������������ĵ�beanFactory
			DefaultListableBeanFactory beanFactory = createBeanFactory();
			// �ͻ����������ã�allowBeanDefinitionOverriding������д��allowCircularReferences������ѭ�����á� 
			customizeBeanFactory(beanFactory);
			// �ص㣺���������ʵ�֣�����XML�����ļ�ΪBeanDefinition,�����뵽beanFactory�ļ��ϲ����С�
			loadBeanDefinitions(beanFactory);
			//ͬ����ʽ���¼��ص�beanFactory��ֵ���������ڲ�beanFactory 
