 ...
 * {@link ConfigurableWebApplicationContext} SPI.
 *
...
public abstract class FrameworkServlet extends HttpServletBean implements ApplicationListener {
	 ...
	 */
	//��������Ǹ���HttpServletBean�е��õģ�����д�˸����еķ�����
	//��д��Http Servlet Bean�ĳ�ʼ��ռλ������initServletBean()��
	//������ʼ�����Serlvet�������Դ�����������WebӦ�ó��򻷾�  
	 ...
	 * @see #setContextConfigLocation
	 */
	//����DispatcherServlet���е������Ķ���
	protected WebApplicationContext initWebApplicationContext() throws BeansException {
		//���Ȳ����Ƿ������ǲ��Servlet��һ��ר�õĸ������������������ͨ��һ�����ԣ�contextAttribute����Ϊ�ؼ��ִ洢��Servlet������ģ�  
        //������Կ�����Servlet�ĳ�ʼ��������ָ������Ϊ��HTTP Servlet Bean�ĳ�ʼ�������У���ʼ��������������ΪBean���Խ��и�ֵ   
		WebApplicationContext wac = findWebApplicationContext();
		 //������Servlet������ר�õĸ�����   
        //ͨ�����ǲ���Ҫ�����������Ϊ����ͨ��ʹ��һ��ContextLoaderListener���м���һ��Ĭ�ϵĹ���ĸ�����     	 	
		if (wac == null) {
			// No fixed context defined for this servlet - create a local one.
			//�������WebApplicationContextUtils��̬�����õ��������ģ�����������ı�����ServletContext
			//ʹ���������������Ϊ��MVC�����ĵ�˫��������
			 //ȡ��Ĭ�ϵĹ���ĸ����������������ͨ���ؼ���ROOT_WEB_APPLICATION_CONTEXT_ATTRIBUTE������Servlet����������    
			WebApplicationContext parent =
					WebApplicationContextUtils.getWebApplicationContext(getServletContext());
			//������ǲ��Servlet���ӻ���������ӻ������õõ���������������������ǿ�ѡ��  
            //һ��������������ӻ�����ȡgetServletName()-servlet.xml�ļ��ļ��ع���  
			wac = createWebApplicationContext(parent);
		}
		 //WebӦ�ó��򻷾��ڴ���֮��ָ�����������ΪWebӦ�ó��򻷾��¼�����ļ�������������WebӦ�ó��򻷾�֧��ˢ��, 
		//���onRefresh����Ӧ���Ѿ����ã�����������Ҫ�ֹ�������ʼ���¼�    
        //���ˢ�·���������ǲ��Servlet��д��������ȡ����ʼ��Spring Web MVC�ĸ��������   
         //���Servlet��ʼ��Ϊ����׼���˳�ʼ��ռλ������initFrameworkServlet(), ���ǣ�ͬʱҲ׼����onRefresh()������  
        //��Ϊһ��ConfigurableApplicationContext��֧�ֶ�̬ˢ�µģ�������WebӦ�ó��򻷾����������Ӧ�ü�����������������³�ʼ����
		//��ǲ��Servlet��������ʵ�ֵ�    
		...
		//�ѵ�ǰ�����������ı��浽ServletContext��ȥ��ע��ʹ�õ��������͵�ǰ��Servlet����ص�
		 //��������˷����������ԣ�������WebӦ�ó��򻷾���ServletContextAttributeName��ֵ��Ϊ�ؼ��ֱ��浽Servlet���������  
        //����ؼ�����org.springframework.web.servlet.FrameworkServlet.CONTEXT. + Servlet����    
	...
	protected WebApplicationContext createWebApplicationContext(WebApplicationContext parent)
		...
		if (this.logger.isDebugEnabled()) {
		  ...
		  //���contextClass�����Ͳ���ConfigurableWebApplicationContext,���׳��쳣  			
		...
		//����ʹ�õ���XmlWebApplicationContext�����Ķ���
		ConfigurableWebApplicationContext wac =
				(ConfigurableWebApplicationContext) BeanUtils.instantiateClass(getContextClass());
		//����˫�׽ڵ����ContextLoader�н�����XmlWebApplicationContext����
		wac.setParent(parent);
		wac.setServletContext(getServletContext());
		wac.setServletConfig(getServletConfig());
		wac.setNamespace(getNamespace());
		 //���ø�����XML�ļ���ŵ�λ��,����Ӧ����getServletName()-servlet.xml�ļ� 
