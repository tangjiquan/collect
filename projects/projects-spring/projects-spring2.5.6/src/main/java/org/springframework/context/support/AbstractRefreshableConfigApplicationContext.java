...
public abstract class AbstractRefreshableConfigApplicationContext extends AbstractRefreshableApplicationContext
	...
	//��beans.xml�����ļ�������AbstractRefreshableConfigApplicationContext������configLocations[]����ַ���������
	 ...
	 * @see #setConfigLocations
	 */
	//��������ǿ�ʵ�֣��Ǹ�����ʵ�ֵģ���XmlWebApplicationContext����д��������������web.xml��û��дapplicationContext.xml��ô��
	//setConfigLocaatons()��ʱ����Ǵ��ݵ�null����ô�ڼ��������ļ���ʱ��ͻ����getDefaultConfigLocations()����Ĭ�ϵ�applicationContext.xml�ļ�
	 ...
	 * @see SystemPropertyUtils#resolvePlaceholders
	 */
