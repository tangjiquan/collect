 ...
 * <li>{@link #setUriResolver(URIResolver) uriResolver}:
 * the {@link URIResolver} to be used in the transform
 * <li>{@link #setErrorListener(ErrorListener) errorListener} (optional):
...
public abstract class AbstractXsltView extends AbstractView {
	 ...
	 * {@link TransformerFactory#newTemplates(Source) attendant templates}
	 * being re-cached.
	 ...
	 * {@link #doTransform(Source, Map, Result, String)}
