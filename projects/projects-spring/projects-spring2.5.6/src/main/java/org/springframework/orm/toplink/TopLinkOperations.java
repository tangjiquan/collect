...
public interface TopLinkOperations {
	 ...
	 * @throws DataAccessException in case of TopLink errors
	 ...
	 * @throws DataAccessException in case of TopLink errors
	 * @see oracle.toplink.sessions.UnitOfWork#registerAllObjects(Collection)
	 */
	 ...
	 * @throws DataAccessException in case of TopLink errors
	 * @see oracle.toplink.sessions.UnitOfWork#deleteAllObjects(Collection)
	 */
