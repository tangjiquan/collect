...
public class XmlWebApplicationContext extends AbstractRefreshableWebApplicationContext {
	...
	//��������BeanDefinition�ĵط���Ĭ������WEB-INF/applicationContext.xml
	 ...
	 */
	//�����ֿ�����loadBeanDefinition����ǰ���IOC����һ���ģ�������صĹ���������refresh()ʱ��������
	//����AbstractRefreshableApplicationContext�е������������
	protected void loadBeanDefinitions(DefaultListableBeanFactory beanFactory) throws IOException {
		// Create a new XmlBeanDefinitionReader for the given BeanFactory.
		//����XmlWebApplication�������Ļ���XmlBeanDefinitionReader
		...
		//��������Ϊreader�����Զ���ĳ�ʼ�����̣�����û��ʵ�֣��Ǹ�����ʵ�ֵ�
		initBeanDefinitionReader(beanDefinitionReader);
		//����ʹ�ö���õ�XmlBeanDefinitionReader������BeanDefinition
	 ...
	 */
	//����ж��BeanDefinition�����ļ�����Ҫ������룬����ͨ��reader����ɵ�
	//�����ʼ���Ĺ�������refreBeanFactory��������ɣ�����ֻ�Ǹ�������BeanDefinition
	 ...
	 */
	//������ȡ��Resourceλ�õĵط���ʹ�����趨��Ĭ������λ�ã�������/WEB-INF/applicatinContext.xml
