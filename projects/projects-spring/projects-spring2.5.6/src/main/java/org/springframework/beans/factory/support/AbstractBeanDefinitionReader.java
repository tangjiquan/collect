...
public abstract class AbstractBeanDefinitionReader implements BeanDefinitionReader {
	 ...
	 */
	//�������register��BeanDefinitionRegister,������������DefaultListableBeanFactory
	protected AbstractBeanDefinitionReader(BeanDefinitionRegistry registry) {
		...
		if (this.registry instanceof ResourceLoader) {
			...
			//ͨ���������ݵ�register����ResourceLoader�����࣬Ҳ��Ҫ����һ��PathMatchingResourcePatternResolver
			//
	...
	//���resourceLoader����AbstractXmlApplication������loadBeanDefinitions()���������ʱ��
	//�ֵ�����XmlBeanDefinitionReader��setResourceLoader(this),��this���ݸ�������resourLoader����
	...
	public int loadBeanDefinitions(String location, Set actualResources) throws BeanDefinitionStoreException {
		...
		if (resourceLoader instanceof ResourcePatternResolver) {
			...
			try {
				//�����resourceLoader����ֲ�������ͨ��getResourceLoader()��������õ��ģ�ͨ��getResourceLoader()�õ���AbstractBeanDefinitions
				//�����ĳ�Ա���������������ʵ��FileSystemXmlApplicationContext�����Ķ���ı�����ΪFileSystemApplicationContext�����
				//��ӵ�ʵ����ResourcePatternResolver��Ҳ��ʵ��resourceLoader()��ӿڣ���ô�ͻ�ʵ��Resource[] getResources(String locationPattern) throws IOException;
				//��ô�Ϳ��������getResources(location)��
			...
			//����DefaultResourceLoaderȡ��Resource
	...
	//���������AbstractXmlApplicatinContext��
	//protected void loadBeanDefinitions(XmlBeanDefinitionReader reader) throws BeansException, IOException {}�������õ�
