...
public abstract class AbstractTrigger<T extends Trigger> implements OperableTrigger {
    ...
    */
     ...
     * </p>
     * 
     * @see TriggerUtils#computeEndTimeToAllowParticularNumberOfFirings(OperableTrigger, org.quartz.Calendar, int)
     */ 
     ...
     * </p>
     *
     * @see TriggerUtils#computeFireTimesBetween(OperableTrigger, org.quartz.Calendar, Date, Date)
     */
